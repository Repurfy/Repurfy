    ...
    },
    {
      ...
      icon: (
        <svg fill="currentColor" className="h-6 w-6 sm:h-8 sm:w-8" viewBox="0 0 24 24">
          ...
          <path d="M20.447 20.452H17.2V14.86c0-1.332-.027-3.047-1.858-3.047-1.859 0-2.142 1.45-2.142 2.946v5.693h-3.25V9h3.125v1.56h.045c.435-.824 1.495-1.69 3.075-1.69 3.287 0 3.895 2.165 3.895 4.978v6.604zM5.337 7.433a1.88 1.88 0 1 1 0-3.761 1.88 1.88 0 0 1 0 3.76zM6.813 20.452H3.86V9h2.954v11.452z" />
        </svg>
      ),
    },
    {
