        ...
        <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <div className="mb-2 flex items-center gap-2">
              <span className="rounded-full border border-teal-500/20 bg-teal-500/10 px-3 py-0.5 text-xs font-medium text-teal-400 capitalize">
          ...
          return (
            ...
            >
              ...
              {stat.label === 'Current Plan' && userData?.plan === 'free' && (
                <Link href="/pricing">
                  <button className="mt-3 cursor-pointer text-xs font-medium text-amber-400 transition-colors hover:text-amber-300">
                    Upgrade →
                  </button>
                </Link>
              )}
