            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between px-4 pt-4 pb-3 sm:px-5 sm:pt-5">
                  ...
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    ...
                    <button
                      ...
                      className={`flex items-center justify-center rounded-lg border p-2 transition ${isEditing
                ...
                <div className="h-0.5 w-full bg-slate-100 dark:bg-slate-700">
                  <div
                    className={`h-full transition-all duration-300 ${isOverLimit ? 'bg-red-400' : charPercent > 80 ? 'bg-amber-400' : 'bg-teal-400'
                      }`}
